...
2. **อีเมลรายงานผู้บริหาร (Daily Evening Summary)**:
   - Apps Script จะสรุปสถิติประจำวัน (จำนวนห้องที่เข้าพัก, ยอดรวม และประวัติกิจกรรม) และส่งเข้าอีเมลของเจ้าของโครงการทุกวันเวลา 18:00 น. ตามทริกเกอร์ที่ตั้งไว้ใน [[google_apps_script_setup#ขั้นตอนที่-4-ตั้งเวลาส่งสรุปตอนเย็นอัตโนมัติ-trigger|คู่มือ Apps Script ขั้นตอนที่ 4]]
