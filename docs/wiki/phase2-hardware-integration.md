...
## 🎯 เป้าหมายหลัก
นำ Raspberry Pi Zero 2 W ไปเชื่อมต่อกับตู้สาขาโทรศัพท์จริงของโรงแรม (**Phonik ECS-103R V.5**) เพื่อควบคุมระบบกระแสไฟฟ้า 220V ในห้องพักโดยตรง

## 🔌 ข้อมูลการเชื่อมต่อ (ตู้ Phonik PBX จริง)
- **IP Address**: `192.168.1.91`
- **Port (Telnet)**: `23`
- **ห้องทดสอบ**: ห้อง `101`
- **การเชื่อมต่อ**: TCP/LAN Mode (สามารถสลับเป็น Serial RS-232 ได้)
