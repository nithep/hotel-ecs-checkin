...
Write-Host "   • Open: snc-poc/frontend/index.html in your browser" -ForegroundColor White
Write-Host "   • Or run: npx serve snc-poc/frontend" -ForegroundColor White
Write-Host ""
Write-Host "🧪 Run Integration Tests:" -ForegroundColor Cyan
Write-Host "   cd snc-poc/backend && python integration_test.py" -ForegroundColor White
Write-Host ""
