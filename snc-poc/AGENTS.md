...
- `snc-poc/frontend`: Web Dashboard สำหรับเคาน์เตอร์พยาบาล (React/Vite) หน้าตาสวยงามพรีเมียม Dark Mode
- `snc-poc/backend`: API Server (FastAPI / Node.js) จัดการ Business Logic, WebSocket และ FHIR Data Schema
- `snc-poc/pbx-connector`: สคริปต์ระดับล่างดักจับและแปลโปรโตคอล SMDR/Telnet สัญญาณเรียกจากตู้ Phonik PBX
- `snc-poc/docs`: เอกสารประกอบโปรเจกต์และการบันทึกสเปกฮาร์ดแวร์
